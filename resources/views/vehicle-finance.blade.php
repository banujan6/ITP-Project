                    ...
                    <div class="col">
                        <div class="card">
                            <ul class="nav nav-tabs nav-justified" role="tablist">
                                <li class="nav-item"> <a class="nav-link active border-bottom-0 border-right-0 border-top-5 border-primary" data-toggle="tab" href="#AddEmployee" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Add Vehicle Finance Info</span></a> </li>
                                <li class="nav-item"> <a class="nav-link border-bottom-0 border-right-0 border-top-5 border-primary" data-toggle="tab" href="#viewEmployees" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Vehicle Finance Report</span></a> </li>
                            </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="lname" placeholder="Account Number Here">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                            ...
                            <div class="tab-pane  p-20" id="viewEmployees" role="tabpanel">
                                <div class="p-20">
                                    <h1>Vehicle Finance Report Goes Here</h1>
                                </div>
                            </div>
                        </div>
                    </div>
