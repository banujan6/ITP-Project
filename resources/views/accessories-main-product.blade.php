            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-md-6 d-flex no-block align-items-center">
                        <h4 class="page-title">Accessories Category Main Products
                        </h4>
                    </div>
                    <div class="col-md-6 d-flex no-block align-items-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-info shadow-none font-weight-bold" data-toggle="modal" data-target=".bd-example-modal-lg">
                                    <i class="fas fa-plus"></i> Add Accessory</a>
                                </button>
                                <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add A New Accessory</h5>
                ...
                buttons: [{
...

                    {
                        ...
                        buttons: [{
                            ...
                            messageTop: 'Accessories-Main-Product Records'
                        }, {
                            extend: 'copy',
                            className: 'dropdown-item',
                            messageTop: 'Accessories-Main-Product Records'
