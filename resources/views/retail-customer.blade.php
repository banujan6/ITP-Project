            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-md-6 d-flex no-block align-items-center">
                        <h4 class="page-title">Retail Customer Management</h4>
                    </div>
                    <div class="col-md-6 d-flex no-block align-items-center">
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">Retail Customer</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="card col-12">
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            <li class="nav-item"><a class="nav-link active border-bottom-0 border-right-0 border-top-5 border-success" data-toggle="tab" href="#retail-customer" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Retail Customer Details</span></a> </li>
                            <li class="nav-item"> <a class="nav-link border-top-5 border-bottom-0 border-success" data-toggle="tab" href="#marketing-report" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Marketing Report</span></a> </li>
                        </ul>
                        <!-- Tab panes -->
