            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Manage Cheques</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="#">Transaction</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Manage Cheques</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <ul class="nav nav-tabs nav-justified" role="tablist">
                                <li class="nav-item"> <a class="nav-link active border-bottom-0 border-right-0 border-top-5 border-warning" data-toggle="tab" href="#AddEmployee" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Depositted Cheques</span></a> </li>
                                <li class="nav-item"> <a class="nav-link border-bottom-0 border-right-0 border-top-5 border-warning" data-toggle="tab" href="#viewEmployees" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Returned Cheques</span></a> </li>
                            </ul>
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active p-20" id="AddEmployee" role="tabpanel">
                                    <div class="p-20">
                                        <h1>Cheque Status Depositted info Goes Here</h1>
                                    </div>
                                </div>
                                <div class="tab-pane  p-20" id="viewEmployees" role="tabpanel">
                                    <div class="p-20">
                                        <h1>Cheque Status Retruned info Goes Here</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
