                                                            ...
                                                            <div class="card">
                                                                <form id="formModal" class="form-horizontal">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <select type="text" class="form-control form-input" id="bankName" placeholder="Bank Name Here" style=" height: 35px; width: 100%">
                                    ...
                                    <table class="table" id="repo">
                                        ...
                                        @foreach($join as $jo)
                                            <tr>
                                                <td></td>
                                                <td>{{ $jo->name}}</td>
                                                <td>{{ $jo->credit_limit}}</td>
                                                <td>{{ $jo->cash}}</td>
                                                <td>@if( ($jo->cash)> ($jo->cash * 5.123))
                                                        Exceeded
                                                    @else
                                                        Normal
                                                    @endif
