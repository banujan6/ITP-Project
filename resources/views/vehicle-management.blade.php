            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Vehicle Managment</h4>
                    ...
                    <div class="col">
                        <div class="card">
                            <ul class="nav nav-tabs nav-justified" role="tablist">
                                <li class="nav-item"> <a class="nav-link active border-bottom-0 border-right-0 border-top-5 border-primary" data-toggle="tab" href="#AddEmployee" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">Add Vehicle</span></a> </li>
                                <li class="nav-item"> <a class="nav-link border-bottom-0 border-right-0 border-top-5 border-primary" data-toggle="tab" href="#viewEmployees" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down font-weight-bold">View Vehicles</span></a> </li>
                            </ul>
                            <div class="tab-content tabcontent-border">
                                        ...
                                        <div class="card-body">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15">Make</label>
                                                    <div class="col-md-9">
                                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                                            <option>Select</option>
                                                            <optgroup>
                                                                <option value="AK">Toyota</option>
                                                                <option value="HI">Honda</option>
                                                                <option value="HI">Mitsubishi</option>
                                                                <option value="HI">Izuzu</option>
                                                                <option value="HI">TATA</option>
                                                            </optgroup>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="lname" class="col-sm-3 text-left control-label col-form-label">Model</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="lname" placeholder="Type Model Here">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15">Year of purchase</label>
                                                    <div class="col-md-9">
                                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                                            <option>Select</option>
                                                            <optgroup>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="lname" placeholder="Type Colour Here">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="lname" class="col-sm-3 text-left control-label col-form-label">Registered Number</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="lname" placeholder="WP XXX XXXX">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15">Capacity</label>
                                                    <div class="col-md-9">
                                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                                            <option>Select</option>
                                                            <optgroup>
                                                                ...
                                                                <option value="AK">1500</option>
                                                                <option value="AK">1000</option>
                                                                <option value="AK">800</option>
                                                            </optgroup>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane  p-20" id="viewEmployees" role="tabpanel">
                                    <div class="p-20">
                                        <h1>Vehicle Edit Delete Table Goes Here</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
