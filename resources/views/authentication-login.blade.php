            ...
            <div class="auth-box bg-light border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-10 p-b-20">
                        <span class="db"><img src="../../assets/images/mass-line-logo.png" alt="logo" width="50%" height="50%" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="login-form-control" action="index.blade.php">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text text-white bg-success" id="basic-addon1"><i class="fas fa-user"></i></span>
                                    </div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text text-white bg-success" id="basic-addon2"><i class="fas fa-key"></i></span>
                                    </div>
