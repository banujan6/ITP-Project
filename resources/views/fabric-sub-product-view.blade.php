            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Blue Fabric</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#">Fabric Sub Product</a></li>
                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-md-6 d-flex flex-column">
                            <div class="header mb-1">
                                <h2 class="text-right display-5">Blue Fabric</h2>
                            ...
                            <div class="row product-description shadow-sm bg-white-rounded">
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8">GSM value</p>
                                </div>
                                <div class="col-sm-8 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8"><Mark>001</Mark></p>
                                </div>
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8">Average yards per role</p>
                                </div>
                                <div class="col-sm-8 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8"><Mark>100</Mark></p>
                                </div>
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8">Weight Type</p>
                                </div>
                                <div class="col-sm-8 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8"><Mark>Heavy Weight </Mark></p>
                                </div>
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8">Water proof</p>
                                </div>
                                <div class="col-sm-8 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8"><Mark>Yes</Mark></p>
                                </div>
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                                ...
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8">Thickness</p>
                                </div>
                                <div class="col-sm-8 shadow-sm bg-white-rounded">
                                    <p class="font-weight-bold display-8"><Mark>50</Mark></p>
                                </div>
                                <div class="col-sm-4 shadow-sm bg-white-rounded">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add New Colored Product </h5>
