                        ...
                        <div class="col-md-6 d-flex flex-column">
                            ...
                            <div class="row colors-category mt-5">
                                ...
                                <div class="col-sm-6 pt-2">
                                    <a href="readymade-sub-product-view.blade.php" class="btn btn-info"></a>
                                    <a href="readymade-sub-product-view.blade.php" class="btn btn-success"></a>
                                    <a href="readymade-sub-product-view.blade.php" class="btn btn-secondary"></a>
                                    <a href="readymade-sub-product-view.blade.php" class="btn btn-warning"></a>
                                    <a href="readymade-sub-product-view.blade.php" class="btn btn-danger"></a>
                                </div>
