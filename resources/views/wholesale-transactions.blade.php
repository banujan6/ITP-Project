            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-md-6 d-flex no-block align-items-center">
                        <h4 class="page-title">WholeSale Transactions</h4>
                    </div>
                    <div class="col-md-6 d-flex no-block align-items-center">
                ...
                <div class="row">
                    <div class="card col-12">
                        ...
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            <li class="nav-item"> <a class="nav-link active font-weight-bold" data-toggle="tab" href="#wholesale-transaction" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Wholesale Transaction Details</span></a> </li>
                            <li class="nav-item"> <a class="nav-link font-weight-bold" data-toggle="tab" href="#invoice-list" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Invoice List</span></a> </li>
                        </ul>
                        <!-- Tab panes -->
