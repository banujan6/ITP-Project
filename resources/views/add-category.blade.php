                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item active"><a href={{"/crud/add_cat"}} class="sidebar-link active"><i class="fas fa-tasks"></i><span class="hide-menu">Manage Categories </span></a></li>
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="../../assets/images/big/img2.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href={{"/crud/bottom_main_product"}}><i class="fas fa-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content d-flex justify-content-between">
