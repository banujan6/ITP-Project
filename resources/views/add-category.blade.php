                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item active"><a href="/categories" class="sidebar-link active"><i class="fas fa-tasks"></i><span class="hide-menu">Manage Categories </span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Product Classification</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row el-element-overlay">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="../../assets/images/big/img1.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="../../assets/images/big/img1.jpg"><i class="fas fa-search-plus"></i></a></li>
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="fabric-main-product.blade.php"><i class="fas fa-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="card shadow-sm bg-white-rounded">
                            <div class="el-card-item pb-3">
                                <div class="el-card-avatar el-overlay-1"> <img src="../../assets/images/big/img2.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="../../assets/images/big/img2.jpg"><i class="fas fa-search-plus"></i></a></li>
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="botttom-main-product.blade.php"><i class="fas fa-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content d-flex justify-content-between">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card shadow-sm bg-white-rounded">
                            <div class="el-card-item pb-3">
                                <div class="el-card-avatar el-overlay-1"> <img src="../../assets/images/big/img3.jfif" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="../../assets/images/big/img3.jfif"><i class="fas fa-search-plus"></i></a></li>
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="readymade-main-product.blade.php"><i class="fas fa-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content d-flex justify-content-between">
                        ...
                        <div class="card shadow-sm bg-white-rounded">
                            <div class="el-card-item pb-3">
                                <div class="el-card-avatar el-overlay-1"> <img src="../../assets/images/big/img4.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="../../assets/images/big/img4.jpg"><i class="fas fa-search-plus"></i></a></li>
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="accessories-main-product.blade.php"><i class="fas fa-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content d-flex justify-content-between">
