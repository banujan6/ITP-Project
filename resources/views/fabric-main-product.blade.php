            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-md-6 d-flex no-block align-items-center">
                        <h4 class="page-title">Fabric Category Main Products
                        </h4>
                    </div>
                    <div class="col-md-6 d-flex no-block align-items-center">
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">Fabric Main Product</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-info shadow-none font-weight-bold" data-toggle="modal" data-target=".bd-example-modal-lg">
                                    <i class="fas fa-plus"></i> Add Fabric</a>
                                </button>
                                <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add A Fabric</h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" id="brand" placeholder="Meterial Here">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="cono1" class="col-sm-3 text-left control-label col-form-label">Colors</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" id="colors" placeholder="Colors Here">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="cono1" class="col-sm-3 text-left control-label col-form-label">Design</label>
                                                                        <div class="col-sm-9">
                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="font-weight-bold">Meterial</th>
                                                <th class="font-weight-bold">Design</th>
                                                <th class="font-weight-bold">Colours</th>
                                                <th class="font-weight-bold">Construction Style</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td></td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Fabric 1</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html' data-href='fabric-sub-product.html'>Adidas</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Cotton</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Abstract</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Red, Blue</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Woven</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>www.google..com</td>
                                                <td class="clickable-row">Lorem ipsum</td>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Fabric 1</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Adidas</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Cotton</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Abstract</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Red, Blue</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Woven</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>www.google..com</td>
                                                <td class="clickable-row" data-href='fabric-sub-product.html'>Lorem ipsum</td>
                                                <td data-toggle="modal" data-target=".bd-example-modal-lg"><button type="button" class="btn btn-cyan btn-sm">Edit</button></td>
                                                <td><button type="button" class="btn btn-danger btn-sm">Delete</button></td>
                                            </tr>
                                            <tr>
